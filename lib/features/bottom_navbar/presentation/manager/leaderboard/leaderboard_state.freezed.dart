...
/// @nodoc
class __$$LoadingCopyWithImpl<$Res> extends _$LeaderboardStateCopyWithImpl<$Res>
...
abstract class Loading implements LeaderboardState {
...
class _$Loaded implements Loaded {
  const _$Loaded({required final List<UserModel> users}) : _users = users;
...
abstract class Loaded implements LeaderboardState {
  const factory Loaded({required final List<UserModel> users}) = _$Loaded;
