...
class _$Loaded implements Loaded {
  const _$Loaded({required this.steps});
  ...
  @override
  String toString() {
    return 'HomeState.loaded(steps: $steps)';
  }
...
abstract class Loaded implements HomeState {
  const factory Loaded({required final String steps}) = _$Loaded;
...
/// @nodoc
abstract class _$$FeedbackGainCopyWith<$Res> {
...
/// @nodoc
class __$$FeedbackGainCopyWithImpl<$Res> extends _$HomeStateCopyWithImpl<$Res>
    implements _$$FeedbackGainCopyWith<$Res> {
  __$$FeedbackGainCopyWithImpl(
      _$FeedbackGain _value, $Res Function(_$FeedbackGain) _then)
      : super(_value, (v) => _then(v as _$FeedbackGain));
